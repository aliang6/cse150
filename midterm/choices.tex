...
\choice \boxed{$Surely you're joking.$}
...
\begin{choices}
\choice \boxed{$At least one of the sets $S_i$ is an infinite set.$}
...
\choice \boxed{$($\mathbb{Z}, \mathbb{Z}$)$}
...
\choice \boxed{$The proof is right.$}
\end{choices}
...
is:
\begin{choices}
\choice \boxed{$Reflexive$}
\choice Symmetric
\choice \boxed{$Transitive$}
\end{choices}
...
\choice \boxed{A \times \emptyset = \emptyset.}
\end{choices}
\vspace{0.2in}
...
\begin{choices}
\choice \boxed{\N\times\Q$ is countable.$}
...
\choice \boxed{$The intersection of finitely many uncountable sets can be countably infinite.$}
\end{choices}
